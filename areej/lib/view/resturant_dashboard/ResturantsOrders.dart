...
class ResturantsOrders extends StatefulWidget {
  const ResturantsOrders({super.key});

  @override
  _ResturantsOrdersState createState() => _ResturantsOrdersState();
}

class _ResturantsOrdersState extends State<ResturantsOrders> {
          ...
          return ListTile(
            ...
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => ResturantsOrderDetail(
                    order: order,
